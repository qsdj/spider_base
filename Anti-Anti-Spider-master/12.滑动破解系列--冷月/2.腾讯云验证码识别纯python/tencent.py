...
class VerifyCode:
    ...
    def GetImg(self, index):
        ...
        return requests.get(url="https://captcha.guard.qcloud.com/cap_union_new_getcapbysig", headers=headers,
    ...
    def GetFirstPackage(self):
        ...
        response = requests.get("https://captcha.guard.qcloud.com/cap_union_prehandle", params=params,
                                headers=self.headers).json()
        self.sess = response["sess"]

    # 第二个包　获取　vsig randstr inity ans
    def GetSecondPackage(self):
        params = "aid=%s&asig=%s&captype=7&protocol=https&clientype=1&disturblevel=1&apptype=&noheader=1&color=1AAD19&showtype=&fb=1&theme=&lang=2052&sess=%s&fwidth=0&uid=&cap_cd=&rnd=%s&rand=%s" % (
        self.aid, self.asig, self.sess, random.randint(100000, 999999), random.random())
    ...
    def FinalPackage(self):
        ...
        return requests.post(url="https://captcha.guard.qcloud.com/cap_union_new_verify", data=postData,
